...
/**
 * HasNeighbor_type0 bean class
 */
public class HasNeighbor_type0 implements org.apache.axis2.databinding.ADBBean {

	private static final long serialVersionUID = -6285401997683688201L;
	...
	private static java.util.HashMap<NMToken, HasNeighbor_type0> _table_ = new java.util.HashMap<NMToken, HasNeighbor_type0>();

	// Constructor
	protected HasNeighbor_type0(org.apache.axis2.databinding.types.NMToken value, boolean isRegisterValue) {
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory)
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, MY_QNAME) {
			...
			public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter)
				...
				HasNeighbor_type0.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
	...
	public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":HasNeighbor_type0", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "HasNeighbor_type0", xmlWriter);
			}
		}
		...
		if (localHasNeighbor_type0 == null) {
			...
			xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localHasNeighbor_type0));
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
		...
		return new org.apache.axis2.databinding.utils.reader.ADBXMLStreamReaderImpl(MY_QNAME, new java.lang.Object[] {
				...
				org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localHasNeighbor_type0) }, null);
	...
	public static class Factory {
		...
		public static HasNeighbor_type0 fromValue(org.apache.axis2.databinding.types.NMToken value) throws java.lang.IllegalArgumentException {
			HasNeighbor_type0 enumeration = _table_.get(value);
		...
		public static HasNeighbor_type0 fromString(java.lang.String value, java.lang.String namespaceURI) throws java.lang.IllegalArgumentException {
			try {
		...
		public static HasNeighbor_type0 fromString(javax.xml.stream.XMLStreamReader xmlStreamReader, java.lang.String content) {
			if (content.indexOf(":") > -1) {
				java.lang.String prefix = content.substring(0, content.indexOf(":"));
				java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
				return HasNeighbor_type0.Factory.fromString(content, namespaceUri);
			} else {
		 ...
		 */
		public static HasNeighbor_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement() || reader.hasText()) {
						...
						if (content.indexOf(":") > 0) {
							...
							object = HasNeighbor_type0.Factory.fromString(content, namespaceuri);
						} else {
							// this seems to be not a qname send and empty namespace
							// incase of
							// it is
							// check is done in fromString method
							object = HasNeighbor_type0.Factory.fromString(content, "");
						}
