...
/**
 * SpelledQueryChoiceE bean class
 */
public class SpelledQueryChoiceE implements org.apache.axis2.databinding.ADBBean, TypeInterface {
	/*
	...
	private static final long serialVersionUID = 4322511906812751521L;
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory)
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName) {
			...
			public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter)
				...
				SpelledQueryChoiceE.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":SpelledQueryChoice", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "SpelledQueryChoice", xmlWriter);
			}
		...
		if (localReplacedTracker) {
			...
			if (!namespace.equals("")) {
				...
				if (prefix == null) {
					...
					xmlWriter.writeStartElement(prefix, "Replaced", namespace);
			...
			if (localReplaced == null) {
				...
				throw new org.apache.axis2.databinding.ADBException("Replaced cannot be null!!");
		...
		if (localOriginalTracker) {
			...
			if (!namespace.equals("")) {
				...
				if (prefix == null) {
					...
					xmlWriter.writeStartElement(prefix, "Original", namespace);
					xmlWriter.writeNamespace(prefix, namespace);
					xmlWriter.setPrefix(prefix, namespace);
			...
			if (localOriginal == null) {
				...
				throw new org.apache.axis2.databinding.ADBException("Original cannot be null!!");
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
		...
		if (localReplacedTracker) {
			elementList.add(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/espell", "Replaced"));

			if (localReplaced != null) {
				elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localReplaced));
			} else {
				throw new org.apache.axis2.databinding.ADBException("Replaced cannot be null!!");
			}
		}
		if (localOriginalTracker) {
			elementList.add(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/espell", "Original"));

			if (localOriginal != null) {
				elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localOriginal));
			} else {
				throw new org.apache.axis2.databinding.ADBException("Original cannot be null!!");
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static SpelledQueryChoiceE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/espell", "Replaced").equals(reader.getName())) {

					java.lang.String content = reader.getElementText();

					object.setReplaced(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/espell", "Original").equals(reader.getName())) {

					java.lang.String content = reader.getElementText();

					object.setOriginal(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
	 ...
	 * <ul>
	 * <li>original - {@link String}</li>
	 * <li>replaced - {@link String}</li>
	 * </ul>
	 * 
	...
	public Map<String, Object> getParametersMap() {
		...
		returnMap.put("original", localOriginal);
		returnMap.put("replaced", localReplaced);
		return returnMap;
	}
