...
/**
 * ELinkResult bean class
 */
public class ELinkResult implements org.apache.axis2.databinding.ADBBean {

	private static final long serialVersionUID = -7692299662248750502L;
	 ...
	 */
	protected gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkSetType[] localLinkSet;
	 ...
	 * 
	 * @return gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkSetType[]
	 */
	 ...
	 */
	protected void validateLinkSet(gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkSetType[] param) {
	 ...
	 * @param param LinkSet
	 */
	public void setLinkSet(gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkSetType[] param) {
	 ...
	 * 
	 * @param param gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkSetType
	 */
	@SuppressWarnings("unchecked")
	public void addLinkSet(gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkSetType param) {
		if (localLinkSet == null) {
			localLinkSet = new gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkSetType[] {};
		}

		// update the setting tracker
		localLinkSetTracker = true;

		java.util.List<LinkSetType> list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localLinkSet);
		list.add(param);
		this.localLinkSet = list.toArray(new gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkSetType[list.size()]);
	...
	public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":eLinkResult", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "eLinkResult", xmlWriter);
			}
			...
			if (localLinkSet != null) {
				for (int i = 0; i < localLinkSet.length; i++) {
					if (localLinkSet[i] != null) {
						localLinkSet[i].serialize(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink", "LinkSet"), factory,
								xmlWriter);
					} else {
				...
				throw new org.apache.axis2.databinding.ADBException("LinkSet cannot be null!!");
		...
		if (localLinkSetTracker) {
			if (localLinkSet != null) {
				for (int i = 0; i < localLinkSet.length; i++) {
					...
					if (localLinkSet[i] != null) {
						elementList.add(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink", "LinkSet"));
	...
	public static class Factory {
		 ...
		 */
		public static ELinkResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"eLinkResult".equals(type)) {
							...
							return (ELinkResult) gov.nih.nlm.ncbi.www.soap.eutils.egquery.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				java.util.ArrayList<LinkSetType> list1 = new java.util.ArrayList<LinkSetType>();

				while (!reader.isStartElement() && !reader.isEndElement())
					reader.next();

				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink", "LinkSet").equals(reader.getName())) {

					// Process the array and step past its final element's end.
					list1.add(gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkSetType.Factory.parse(reader));
					...
					while (!loopDone1) {
						...
						if (reader.isEndElement()) {
							...
							if (new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink", "LinkSet").equals(reader.getName())) {
								list1.add(gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkSetType.Factory.parse(reader));
					...
					object.setLinkSet((gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkSetType[]) org.apache.axis2.databinding.utils.ConverterUtil
							.convertToArray(gov.nih.nlm.ncbi.www.soap.eutils.elink.LinkSetType.class, list1));
