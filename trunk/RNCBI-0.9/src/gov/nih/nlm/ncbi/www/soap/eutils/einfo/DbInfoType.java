...
/**
 * DbInfoType bean class
 */

public class DbInfoType implements org.apache.axis2.databinding.ADBBean, TypeInterface {
	/*
	 * This type was generated from the piece of schema that had name =
	 * DbInfoType Namespace URI = http://www.ncbi.nlm.nih.gov/soap/eutils/einfo
	 * Namespace Prefix = ns2
	 */

	private static final long serialVersionUID = 5883233362179347465L;
	...
	protected gov.nih.nlm.ncbi.www.soap.eutils.einfo.FieldListType localFieldList;

	/**
	 * Auto generated getter method
	 * 
	 * @return gov.nih.nlm.ncbi.www.soap.eutils.einfo.FieldListType
	 */
	 ...
	 */
	public void setFieldList(gov.nih.nlm.ncbi.www.soap.eutils.einfo.FieldListType param) {
	...
	protected gov.nih.nlm.ncbi.www.soap.eutils.einfo.LinkListType localLinkList;
	 ...
	 * Auto generated getter method
	 * 
	 * @return gov.nih.nlm.ncbi.www.soap.eutils.einfo.LinkListType
	 */
	 ...
	 */
	public void setLinkList(gov.nih.nlm.ncbi.www.soap.eutils.einfo.LinkListType param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":DbInfoType", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DbInfoType", xmlWriter);
			}
		...
		localFieldList.serialize(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/einfo", "FieldList"), factory, xmlWriter);
		if (localLinkListTracker) {
			if (localLinkList == null) {
				throw new org.apache.axis2.databinding.ADBException("LinkList cannot be null!!");
			}
			localLinkList.serialize(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/einfo", "LinkList"), factory, xmlWriter);
		}
		xmlWriter.writeEndElement();
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
		...
		elementList.add(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/einfo", "DbName"));
		...
		elementList.add(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/einfo", "MenuName"));
		...
		elementList.add(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/einfo", "Count"));
		...
		elementList.add(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/einfo", "LastUpdate"));
		...
		elementList.add(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/einfo", "FieldList"));
		...
		if (localLinkListTracker) {
			elementList.add(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/einfo", "LinkList"));
	...
	public static class Factory {
		 ...
		 */
		public static DbInfoType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"DbInfoType".equals(type)) {
							...
							return (DbInfoType) gov.nih.nlm.ncbi.www.soap.eutils.egquery.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/einfo", "DbName").equals(reader.getName())) {
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/einfo", "MenuName").equals(reader.getName())) {
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/einfo", "Count").equals(reader.getName())) {
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/einfo", "LastUpdate").equals(reader.getName())) {

					java.lang.String content = reader.getElementText();

					object.setLastUpdate(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/einfo", "FieldList").equals(reader.getName())) {

					object.setFieldList(gov.nih.nlm.ncbi.www.soap.eutils.einfo.FieldListType.Factory.parse(reader));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/einfo", "LinkList").equals(reader.getName())) {

					object.setLinkList(gov.nih.nlm.ncbi.www.soap.eutils.einfo.LinkListType.Factory.parse(reader));
	 ...
	 * <li>lastupdate - {@link String}</li>
	 * <li>menuname - {@link String}</li>
	 * <li>fieldlist - {@link FieldType} Array</li>
	 * <li>linklist - {@link LinkType} Array</li>
	 * </ul>
	 * 
	...
	public Map<String, Object> getParametersMap() {
		...
		returnMap.put("lastupdate", localLastUpdate);
		returnMap.put("menuname", localMenuName);
		returnMap.put("fieldlist", localFieldList.getField());
		returnMap.put("linklist", localLinkList.getLink());
		return returnMap;
	}
