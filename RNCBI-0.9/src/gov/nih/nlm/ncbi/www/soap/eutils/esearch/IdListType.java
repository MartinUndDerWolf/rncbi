 ...
 */
public class IdListType implements org.apache.axis2.databinding.ADBBean, TypeInterface {

	private static final long serialVersionUID = 5549542385981089911L;

	/**
	 * This type was generated from the piece of schema that had name =
	 * IdListType Namespace URI = http://www.ncbi.nlm.nih.gov/soap/eutils/esearch
		...
		if (localIdTracker) {
			if (localId != null) {
				for (int i = 0; i < localId.length; i++) {
					...
					if (localId[i] != null) {
						elementList.add(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/esearch", "Id"));
		...
		public static IdListType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"IdListType".equals(type)) {
							...
							return (IdListType) gov.nih.nlm.ncbi.www.soap.eutils.egquery.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/esearch", "Id").equals(reader.getName())) {
					...
					while (!loopDone1) {
						...
						if (reader.isEndElement()) {
							...
							if (new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/esearch", "Id").equals(reader.getName())) {
								list1.add(reader.getElementText());
					...
					object.setId(list1.toArray(new java.lang.String[list1.size()]));
