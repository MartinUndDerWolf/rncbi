...
/**
 * LinkTypeE bean class
 */
public class LinkTypeE implements org.apache.axis2.databinding.ADBBean, TypeInterface {
	/*
	...
	private static final long serialVersionUID = -4372640037842076449L;
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
		...
		if (localScoreTracker) {
			elementList.add(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink", "Score"));
	...
	public static class Factory {
		 ...
		 */
		public static LinkTypeE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"LinkType".equals(type)) {
							...
							return (LinkTypeE) gov.nih.nlm.ncbi.www.soap.eutils.egquery.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink", "Score").equals(reader.getName())) {
	...
	public Map<String, Object> getParametersMap() {
		...
		returnMap.put("score", localScore);
		return returnMap;
	}
