 ...
 */
public class IdUrlListType implements org.apache.axis2.databinding.ADBBean, TypeInterface {
	/*
	...
	private static final long serialVersionUID = -1443926254288304074L;
	...
	public void addIdUrlSet(gov.nih.nlm.ncbi.www.soap.eutils.elink.IdUrlSetType param) {
		...
		java.util.List<IdUrlSetType> list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localIdUrlSet);
		list.add(param);
		this.localIdUrlSet = list.toArray(new gov.nih.nlm.ncbi.www.soap.eutils.elink.IdUrlSetType[list.size()]);
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory)
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName) {
			...
			public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter)
				...
				IdUrlListType.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":IdUrlListType", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "IdUrlListType", xmlWriter);
			}
			...
			if (localIdUrlSet != null) {
				for (int i = 0; i < localIdUrlSet.length; i++) {
					if (localIdUrlSet[i] != null) {
						localIdUrlSet[i].serialize(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink", "IdUrlSet"), factory,
								xmlWriter);
					} else {
		...
		if (localIdUrlSetTracker) {
			if (localIdUrlSet != null) {
				for (int i = 0; i < localIdUrlSet.length; i++) {
					...
					if (localIdUrlSet[i] != null) {
						elementList.add(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink", "IdUrlSet"));
	...
	public static class Factory {
		...
		public static IdUrlListType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"IdUrlListType".equals(type)) {
							...
							return (IdUrlListType) gov.nih.nlm.ncbi.www.soap.eutils.egquery.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				java.util.ArrayList<IdUrlSetType> list1 = new java.util.ArrayList<IdUrlSetType>();

				while (!reader.isStartElement() && !reader.isEndElement())
					reader.next();

				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/elink", "IdUrlSet").equals(reader.getName())) {
					...
					object.setIdUrlSet((gov.nih.nlm.ncbi.www.soap.eutils.elink.IdUrlSetType[]) org.apache.axis2.databinding.utils.ConverterUtil
							.convertToArray(gov.nih.nlm.ncbi.www.soap.eutils.elink.IdUrlSetType.class, list1));
	 ...
	 * <li>idurlset - {@link IdUrlSetType}[]</li>
	 * </ul>
	 * 
	...
	public Map<String, Object> getParametersMap() {
		...
		returnMap.put("idurlset", localIdUrlSet);
		return returnMap;
	}
