/**
 * TranslationStackTypeChoice.java
 *
...
/**
 * TranslationStackTypeChoice bean class
 */
public class TranslationStackTypeChoice implements org.apache.axis2.databinding.ADBBean, TypeInterface {
	 ...
	 * field for TermSet
	 */
	protected gov.nih.nlm.ncbi.www.soap.eutils.esearch.TermSetType localTermSet;
	 ...
	 * 
	 * @return gov.nih.nlm.ncbi.www.soap.eutils.esearch.TermSetType
	 */
	 ...
	 * @param param TermSet
	 */
	public void setTermSet(gov.nih.nlm.ncbi.www.soap.eutils.esearch.TermSetType param) {
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory)
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName) {
			...
			public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter)
				...
				TranslationStackTypeChoice.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":TranslationStackTypeChoice", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "TranslationStackTypeChoice", xmlWriter);
			}

		}
		if (localTermSetTracker) {
			if (localTermSet == null) {
				throw new org.apache.axis2.databinding.ADBException("TermSet cannot be null!!");
			}
			localTermSet.serialize(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/esearch", "TermSet"), factory, xmlWriter);
		}
		if (localOPTracker) {
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
		...
		if (localTermSetTracker) {
			elementList.add(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/esearch", "TermSet"));
		...
		if (localOPTracker) {
			elementList.add(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/esearch", "OP"));
	...
	public static class Factory {
		 ...
		 */
		public static TranslationStackTypeChoice parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/esearch", "TermSet").equals(reader.getName())) {

					object.setTermSet(gov.nih.nlm.ncbi.www.soap.eutils.esearch.TermSetType.Factory.parse(reader));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/esearch", "OP").equals(reader.getName())) {

					java.lang.String content = reader.getElementText();

					object.setOP(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
	 ...
	 * <ul>
	 * <li>from - {@link String}</li>
	 * <li>to - {@link TermSetType}</li>
	 * </ul>
	 * 
	...
	public Map<String, Object> getParametersMap() {
		...
		returnMap.put("op", localOP);
		returnMap.put("termset", localTermSet);
		return returnMap;
	}
}
