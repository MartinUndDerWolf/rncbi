...
/**
 * DbListType bean class
 */

public class DbListType implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * DbListType Namespace URI = http://www.ncbi.nlm.nih.gov/soap/eutils/einfo
	 * Namespace Prefix = ns2
	 */

	private static final long serialVersionUID = -1621300244841710430L;
	...
	public void addDbName(java.lang.String param) {
		...
		java.util.List<String> list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localDbName);
		list.add(param);
		this.localDbName = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
	...
	public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":DbListType", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DbListType", xmlWriter);
			}
					...
					if (localDbName[i] != null) {
						...
						if (!emptyNamespace) {
							if (prefix == null) {
								...
								xmlWriter.writeStartElement(prefix2, "DbName", namespace);
						...
						xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDbName[i]));
			...
			if (localDbName != null) {
				for (int i = 0; i < localDbName.length; i++) {
					...
					if (localDbName[i] != null) {
						...
						elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDbName[i]));
					} else {
	...
	public static class Factory {
		 ...
		 */
		public static DbListType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"DbListType".equals(type)) {
							...
							return (DbListType) gov.nih.nlm.ncbi.www.soap.eutils.egquery.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
						...
						if (reader.isStartElement()
							...
							while (!loopDone1) {
								...
								if (reader.isEndElement()) {
									...
									if (new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/einfo", "DbName").equals(reader.getName())) {
										list1.add(reader.getElementText());
							...
							object.setDbName((java.lang.String[]) list1.toArray(new java.lang.String[list1.size()]));
