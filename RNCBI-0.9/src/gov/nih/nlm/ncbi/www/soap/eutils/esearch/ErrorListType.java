 ...
 */
public class ErrorListType implements org.apache.axis2.databinding.ADBBean, TypeInterface {
	/*
	...
	private static final long serialVersionUID = -444862047818044498L;
	...
	public void addPhraseNotFound(java.lang.String param) {
		...
		java.util.List<String> list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localPhraseNotFound);
		list.add(param);
		this.localPhraseNotFound = list.toArray(new java.lang.String[list.size()]);
	...
	public void addFieldNotFound(java.lang.String param) {
		...
		java.util.List<String> list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localFieldNotFound);
		list.add(param);
		this.localFieldNotFound = list.toArray(new java.lang.String[list.size()]);
	...
	public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory)
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this, parentQName) {
			...
			public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter)
				...
				ErrorListType.this.serialize(parentQName, factory, xmlWriter);
			}
		};
	...
	public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":ErrorListType", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ErrorListType", xmlWriter);
			}
					...
					if (localPhraseNotFound[i] != null) {
						...
						if (!emptyNamespace) {
							if (prefix == null) {
								...
								xmlWriter.writeStartElement(prefix2, "PhraseNotFound", namespace);
								xmlWriter.writeNamespace(prefix2, namespace);
								xmlWriter.setPrefix(prefix2, namespace);

							} else {
								xmlWriter.writeStartElement(namespace, "PhraseNotFound");
							}
					...
					if (localFieldNotFound[i] != null) {
						...
						if (!emptyNamespace) {
							if (prefix == null) {
								...
								xmlWriter.writeStartElement(prefix2, "FieldNotFound", namespace);
								xmlWriter.writeNamespace(prefix2, namespace);
								xmlWriter.setPrefix(prefix2, namespace);

							} else {
								xmlWriter.writeStartElement(namespace, "FieldNotFound");
							}
		...
		if (localPhraseNotFoundTracker) {
			if (localPhraseNotFound != null) {
				for (int i = 0; i < localPhraseNotFound.length; i++) {
					...
					if (localPhraseNotFound[i] != null) {
						elementList.add(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/esearch", "PhraseNotFound"));
						elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPhraseNotFound[i]));
					} else {
		...
		if (localFieldNotFoundTracker) {
			if (localFieldNotFound != null) {
				for (int i = 0; i < localFieldNotFound.length; i++) {
					...
					if (localFieldNotFound[i] != null) {
						elementList.add(new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/esearch", "FieldNotFound"));
						elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localFieldNotFound[i]));
					} else {
		...
		public static ErrorListType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"ErrorListType".equals(type)) {
							...
							return (ErrorListType) gov.nih.nlm.ncbi.www.soap.eutils.egquery.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/esearch", "PhraseNotFound").equals(reader.getName())) {
					...
					object.setPhraseNotFound(list1.toArray(new java.lang.String[list1.size()]));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.ncbi.nlm.nih.gov/soap/eutils/esearch", "FieldNotFound").equals(reader.getName())) {
					...
					object.setFieldNotFound(list2.toArray(new java.lang.String[list2.size()]));
	 ...
	 * <ul>
	 * <li>fieldnotfound - {@link String}[]</li>
	 * <li>phrasenotfound - {@link String}[]</li>
	 * </ul>
	 * 
	...
	public Map<String, Object> getParametersMap() {
		...
		returnMap.put("fieldnotfound", localFieldNotFound);
		returnMap.put("phrasenotfound", localPhraseNotFound);
		return returnMap;
	}
